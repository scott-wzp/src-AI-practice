...
val_accuracy = accuracy_score(y_val, dt_model.predict(X_val))
...
# 5. 保存验证结果到文件
with open('model_validation_results.txt', 'w', encoding='utf-8') as f:
    f.write("决策树模型验证结果\n")
    f.write("=" * 50 + "\n\n")
...
print("\n验证结果已保存到 model_validation_results.txt")
